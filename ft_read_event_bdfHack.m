function [event] = ft_read_event_bdfHack(filename, varargin)
...
%
% 2016-02-18 Bauke van der Velde:
% hack added to correctly read-in BDF-files and triggers
